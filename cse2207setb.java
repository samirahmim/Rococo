...
public class cse2207setb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cse2207setb);
    ...
    private void showBottomSheet(){
        BottomSheetDialog bottomSheetDialog=new BottomSheetDialog(cse2207setb.this);
    ...
    private void getquizques(ArrayList<QuizModelcse2201>quizModelcse2201s) {
        quizModelcse2201s.add(new QuizModelcse2201("Dijkstra's algorithm is a priority first algorithm","true","false","none","all above","true"));
        quizModelcse2201s.add(new QuizModelcse2201("The knapsack problem is a problem in-","combinatorial optimization","combinatorial optimization","none","both","both"));
        ...
        quizModelcse2201s.add(new QuizModelcse2201("ukp","unbounded knapsack problem ","unbounded knapsack problem","both","none","both"));
