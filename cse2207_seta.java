...
public class cse2207_seta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cse2207_seta);
    ...
    private void showBottomSheet(){
        BottomSheetDialog bottomSheetDialog=new BottomSheetDialog(cse2207_seta.this);
    ...
    private void getquizques(ArrayList<QuizModelcse2201>quizModelcse2201s) {
        quizModelcse2201s.add(new QuizModelcse2201("travelling Salesman Problem is based on a real life scenario, where a salesman from a company has to start from his own city and visit all the assigned cities exactly once and return to his home till the end of the day.","true","false","none","all above","true"));
        quizModelcse2201s.add(new QuizModelcse2201("A graph is a non-linear data structure that involves-","nodes","edges","both","none","both"));
        quizModelcse2201s.add(new QuizModelcse2201("Dijkstra’s algorithm is also known as the shortest path algorithm","true","false","none","all above","true"));
        quizModelcse2201s.add(new QuizModelcse2201("Dijkstra's algorithm only works ","with the graph that possesses positive weights","with the graph that possesses positive path","with the graph that possesses positive edges","with the graph that possesses positive nodes","with the graph that possesses positive weights"));
        quizModelcse2201s.add(new QuizModelcse2201("dijkstra's algorithm uses-","a greedy approach to solve the problem and find the best solution","a nongreedy approach to solve the problem and find the best solutin","none","both","a greedy approach to solve the problem and find the best solution"));
