...
public class math2203setb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math2203setb);
    ...
    private void showBottomSheet(){
        BottomSheetDialog bottomSheetDialog=new BottomSheetDialog(math2203setb.this);
    ...
    private void getquizques(ArrayList<QuizModelcse2201>quizModelcse2201s) {
        quizModelcse2201s.add(new QuizModelcse2201("It is also possible to consider matrices with infinitely many rows and/or columns-","true","false","none","all above","true"));
        ...
        quizModelcse2201s.add(new QuizModelcse2201("Vectors may be visualized as directed line segments whose lengths are their magnitudes","true","false","none","all above","true"));
        quizModelcse2201s.add(new QuizModelcse2201("Two vectors can be-"," added","subtracted","both","none ","added"));
