...
public class cse2213_seta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cse2213_seta);
    ...
    private void showBottomSheet(){
        BottomSheetDialog bottomSheetDialog=new BottomSheetDialog(cse2213_seta.this);
    ...
    private void getquizques(ArrayList<QuizModelcse2201>quizModelcse2201s) {
        quizModelcse2201s.add(new QuizModelcse2201("1.ROM-","read only memory","read on memory","both","none","read only memory"));
        quizModelcse2201s.add(new QuizModelcse2201("1 byte=","8 bit","32 bit","2 bit","none","8 bit"));
        quizModelcse2201s.add(new QuizModelcse2201("8086 microprocessor-","32 bit","8 bit","16 bit","none",""));
        quizModelcse2201s.add(new QuizModelcse2201("8086 has-","9 flags","10 flags","2 flags","none","9 flags"));
