...
public class cse2209_seta extends AppCompatActivity {
    ...
    private void showBottomSheet(){
        BottomSheetDialog bottomSheetDialog=new BottomSheetDialog(cse2209_seta.this);
    ...
    private void getquizques(ArrayList<QuizModelcse2201>quizModelcse2201s) {
        ...
        quizModelcse2201s.add(new QuizModelcse2201("Diode allows current to flow-","in 2 direction","in 3 direction","in 1 direction","nowhere","in 1 direction"));
        quizModelcse2201s.add(new QuizModelcse2201("in saturation mode transistor acts like-","open circuit","short circuit","none","all above","short circuit"));
        quizModelcse2201s.add(new QuizModelcse2201("fan in depends on-","input","output","diode","none","input"));
        quizModelcse2201s.add(new QuizModelcse2201("in saturation the value of Vbe-","0.7","0.8","0.9","0.2","0.8"));
